...
int main() {
    ...
    if(res == 0){
        printf("Cliente1: recibí que %ld NO es primo del servidor!\n", num);
    }
    else if(res == 1){
        printf("Cliente1: recibí que %ld es primo del servidor!\n", num);
    }else{
        printf("Cliente1: recibí %d. Respuesta incorrecta del servidor!\n", res);
    }
